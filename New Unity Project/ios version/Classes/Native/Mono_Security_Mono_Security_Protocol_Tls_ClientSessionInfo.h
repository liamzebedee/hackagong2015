...
struct  ClientSessionInfo_t787  : public Object_t
{
	...
	ByteU5BU5D_t67* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t67* ___masterSecret_5;
};
struct ClientSessionInfo_t787_StaticFields{
