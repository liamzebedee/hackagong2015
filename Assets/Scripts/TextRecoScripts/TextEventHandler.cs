...
public class TextEventHandler : MonoBehaviour, ITextRecoEventHandler, IVideoBackgroundEventHandler
{
    ...
    private float mLoupeHeight = 0.9f;
    ...
    private void DrawWordList()
    {
        ...
        var textBoxWidth = 120.0f;
        var textBoxHeight = 500.0f;
        var textBoxOffsetLeft = 10.0f;
        var textBoxOffsetTop = 120.0f;
    ...
    private void CalculateLoupeRegion()
    {
        // define area for text search
			...
			var loupeHeight = mLoupeHeight * Screen.height * 0.5f;
			var leftOffset = 0.0f;
