...
extern "C"
{
	...
	const char*			UnityIPhoneRuntimeVersion = "5.2.0f3";
...
#define DLL_EXPORT __declspec(dllexport)
	...
	DECL_USER_FUNC(setPlatFormNative);
	DECL_USER_FUNC(initQCARiOS);
	DECL_USER_FUNC(setSurfaceOrientationiOS);
	DECL_USER_FUNC(smartTerrainTrackerStart);
	DECL_USER_FUNC(smartTerrainTrackerStop);
	DECL_USER_FUNC(smartTerrainTrackerSetScaleToMillimeter);
	DECL_USER_FUNC(smartTerrainTrackerInitBuilder);
	DECL_USER_FUNC(smartTerrainTrackerDeinitBuilder);
	DECL_USER_FUNC(smartTerrainBuilderCreateReconstructionFromTarget);
	DECL_USER_FUNC(smartTerrainBuilderCreateReconstructionFromEnvironment);
	DECL_USER_FUNC(smartTerrainBuilderAddReconstruction);
	DECL_USER_FUNC(smartTerrainBuilderRemoveReconstruction);
	DECL_USER_FUNC(smartTerrainBuilderDestroyReconstruction);
	DECL_USER_FUNC(reconstructionStart);
	DECL_USER_FUNC(reconstructionStop);
	DECL_USER_FUNC(reconstructionIsReconstructing);
	DECL_USER_FUNC(reconstructionReset);
	DECL_USER_FUNC(reconstructionSetNavMeshPadding);
	DECL_USER_FUNC(reconstructionFromTargetSetInitializationTarget);
	DECL_USER_FUNC(reconstructionSetMaximumArea);
	DECL_USER_FUNC(reconstructioFromEnvironmentGetReconstructionState);
	DECL_USER_FUNC(cameraDeviceInitCamera);
	DECL_USER_FUNC(cameraDeviceDeinitCamera);
	DECL_USER_FUNC(cameraDeviceStartCamera);
	DECL_USER_FUNC(cameraDeviceStopCamera);
	DECL_USER_FUNC(cameraDeviceGetNumVideoModes);
	DECL_USER_FUNC(cameraDeviceGetVideoMode);
	DECL_USER_FUNC(cameraDeviceSelectVideoMode);
	DECL_USER_FUNC(cameraDeviceSetFlashTorchMode);
	DECL_USER_FUNC(cameraDeviceSetFocusMode);
	DECL_USER_FUNC(cameraDeviceSetCameraConfiguration);
	DECL_USER_FUNC(cameraDeviceGetCameraFieldOfViewRads);
	DECL_USER_FUNC(qcarSetFrameFormat);
	DECL_USER_FUNC(dataSetExists);
	DECL_USER_FUNC(dataSetLoad);
	DECL_USER_FUNC(dataSetGetNumTrackableType);
	DECL_USER_FUNC(dataSetGetTrackablesOfType);
	DECL_USER_FUNC(dataSetGetTrackableName);
	DECL_USER_FUNC(dataSetCreateTrackable);
	DECL_USER_FUNC(dataSetDestroyTrackable);
	DECL_USER_FUNC(dataSetHasReachedTrackableLimit);
	DECL_USER_FUNC(getCameraThreadID);
	DECL_USER_FUNC(imageTargetBuilderBuild);
	DECL_USER_FUNC(frameCounterGetBenchmarkingData);
	DECL_USER_FUNC(imageTargetBuilderStartScan);
	DECL_USER_FUNC(imageTargetBuilderStopScan);
	DECL_USER_FUNC(imageTargetBuilderGetFrameQuality);
	DECL_USER_FUNC(imageTargetBuilderGetTrackableSource);
	DECL_USER_FUNC(imageTargetCreateVirtualButton);
	DECL_USER_FUNC(imageTargetDestroyVirtualButton);
	DECL_USER_FUNC(virtualButtonGetId);
	DECL_USER_FUNC(imageTargetGetNumVirtualButtons);
	DECL_USER_FUNC(imageTargetGetVirtualButtons);
	DECL_USER_FUNC(imageTargetGetVirtualButtonName);
	DECL_USER_FUNC(cylinderTargetGetDimensions);
	DECL_USER_FUNC(cylinderTargetSetSideLength);
	DECL_USER_FUNC(cylinderTargetSetTopDiameter);
	DECL_USER_FUNC(cylinderTargetSetBottomDiameter);
	DECL_USER_FUNC(objectTargetSetSize);
	DECL_USER_FUNC(objectTargetGetSize);
	DECL_USER_FUNC(objectTrackerStart);
	DECL_USER_FUNC(objectTrackerStop);
	DECL_USER_FUNC(objectTrackerCreateDataSet);
	DECL_USER_FUNC(objectTrackerDestroyDataSet);
	DECL_USER_FUNC(objectTrackerActivateDataSet);
	DECL_USER_FUNC(objectTrackerDeactivateDataSet);
	DECL_USER_FUNC(objectTrackerPersistExtendedTracking);
	DECL_USER_FUNC(objectTrackerResetExtendedTracking);
	DECL_USER_FUNC(markerSetSize);
	DECL_USER_FUNC(markerTrackerStart);
	DECL_USER_FUNC(markerTrackerStop);
	DECL_USER_FUNC(markerTrackerCreateMarker);
	DECL_USER_FUNC(markerTrackerDestroyMarker);
	DECL_USER_FUNC(initPlatformNative);
	DECL_USER_FUNC(initFrameState);
	DECL_USER_FUNC(deinitFrameState);
	DECL_USER_FUNC(onSurfaceChanged);
	DECL_USER_FUNC(onPause);
	DECL_USER_FUNC(onResume);
	DECL_USER_FUNC(hasSurfaceBeenRecreated);
	DECL_USER_FUNC(updateQCAR);
	DECL_USER_FUNC(rendererEnd);
	DECL_USER_FUNC(qcarGetBufferSize);
	DECL_USER_FUNC(qcarAddCameraFrame);
	DECL_USER_FUNC(rendererSetVideoBackgroundCfg);
	DECL_USER_FUNC(rendererGetVideoBackgroundCfg);
	DECL_USER_FUNC(rendererGetVideoBackgroundTextureInfo);
	DECL_USER_FUNC(rendererSetVideoBackgroundTextureID);
	DECL_USER_FUNC(rendererIsVideoBackgroundTextureInfoAvailable);
	DECL_USER_FUNC(rendererGetRecommendedFps);
	DECL_USER_FUNC(qcarInit);
	DECL_USER_FUNC(qcarSetHint);
	DECL_USER_FUNC(getProjectionGL);
	DECL_USER_FUNC(setApplicationEnvironment);
	DECL_USER_FUNC(setStateBufferSize);
	DECL_USER_FUNC(targetFinderStartInit);
	DECL_USER_FUNC(targetFinderGetInitState);
	DECL_USER_FUNC(targetFinderDeinit);
	DECL_USER_FUNC(targetFinderStartRecognition);
	DECL_USER_FUNC(targetFinderStop);
	DECL_USER_FUNC(targetFinderSetUIScanlineColor);
	DECL_USER_FUNC(targetFinderSetUIPointColor);
	DECL_USER_FUNC(targetFinderUpdate);
	DECL_USER_FUNC(targetFinderGetResults);
	DECL_USER_FUNC(targetFinderEnableTracking);
	DECL_USER_FUNC(targetFinderGetImageTargets);
	DECL_USER_FUNC(targetFinderClearTrackables);
	DECL_USER_FUNC(textTrackerStart);
	DECL_USER_FUNC(textTrackerStop);
	DECL_USER_FUNC(textTrackerSetRegionOfInterest);
	DECL_USER_FUNC(textTrackerGetRegionOfInterest);
	DECL_USER_FUNC(wordListLoadWordList);
	DECL_USER_FUNC(wordListAddWordsFromFile);
	DECL_USER_FUNC(wordListAddWordU);
	DECL_USER_FUNC(wordListRemoveWordU);
	DECL_USER_FUNC(wordListContainsWordU);
	DECL_USER_FUNC(wordListUnloadAllLists);
	DECL_USER_FUNC(wordListSetFilterMode);
	DECL_USER_FUNC(wordListGetFilterMode);
	DECL_USER_FUNC(wordListAddWordToFilterListU);
	DECL_USER_FUNC(wordListRemoveWordFromFilterListU);
	DECL_USER_FUNC(wordListClearFilterList);
	DECL_USER_FUNC(wordListLoadFilterList);
	DECL_USER_FUNC(wordListGetFilterListWordCount);
	DECL_USER_FUNC(wordListGetFilterListWordU);
	DECL_USER_FUNC(wordGetLetterMask);
	DECL_USER_FUNC(wordGetLetterBoundingBoxes);
	DECL_USER_FUNC(trackerManagerInitTracker);
	DECL_USER_FUNC(trackerManagerDeinitTracker);
	DECL_USER_FUNC(virtualButtonSetEnabled);
	DECL_USER_FUNC(virtualButtonSetSensitivity);
	DECL_USER_FUNC(virtualButtonSetAreaRectangle);
	DECL_USER_FUNC(qcarDeinit);
	DECL_USER_FUNC(startExtendedTracking);
	DECL_USER_FUNC(stopExtendedTracking);
	DECL_USER_FUNC(eyewearIsDeviceDetected);
	DECL_USER_FUNC(eyewearSetHeadsetPresent);
	DECL_USER_FUNC(eyewearSetHeadsetNotPresent);
	DECL_USER_FUNC(eyewearIsSeeThru);
	DECL_USER_FUNC(eyewearGetScreenOrientation);
	DECL_USER_FUNC(eyewearIsStereoCapable);
	DECL_USER_FUNC(eyewearIsStereoEnabled);
	DECL_USER_FUNC(eyewearIsStereoGLOnly);
	DECL_USER_FUNC(eyewearSetStereo);
	DECL_USER_FUNC(eyewearIsPredictiveTrackingEnabled);
	DECL_USER_FUNC(eyewearSetPredictiveTracking);
	DECL_USER_FUNC(eyewearSetProjectionClippingPlanes);
	DECL_USER_FUNC(eyewearGetProjectionMatrix);
	DECL_USER_FUNC(eyewearCPMGetMaxCount);
	DECL_USER_FUNC(eyewearCPMGetUsedCount);
	DECL_USER_FUNC(eyewearCPMIsProfileUsed);
	DECL_USER_FUNC(eyewearCPMGetActiveProfile);
	DECL_USER_FUNC(eyewearCPMSetActiveProfile);
	DECL_USER_FUNC(eyewearCPMGetProjectionMatrix);
	DECL_USER_FUNC(eyewearCPMSetProjectionMatrix);
	DECL_USER_FUNC(eyewearCPMGetProfileName);
	DECL_USER_FUNC(eyewearCPMSetProfileName);
	DECL_USER_FUNC(eyewearCPMClearProfile);
	DECL_USER_FUNC(eyewearUserCalibratorInit);
	DECL_USER_FUNC(eyewearUserCalibratorGetMinScaleHint);
	DECL_USER_FUNC(eyewearUserCalibratorGetMaxScaleHint);
	DECL_USER_FUNC(eyewearUserCalibratorIsStereoStretched);
	DECL_USER_FUNC(eyewearUserCalibratorGetProjectionMatrix);
}
DLL_EXPORT void RegisterMonoModules()
{
	...
	REGISTER_USER_FUNC(setPlatFormNative);
	REGISTER_USER_FUNC(initQCARiOS);
	REGISTER_USER_FUNC(setSurfaceOrientationiOS);
	REGISTER_USER_FUNC(smartTerrainTrackerStart);
	REGISTER_USER_FUNC(smartTerrainTrackerStop);
	REGISTER_USER_FUNC(smartTerrainTrackerSetScaleToMillimeter);
	REGISTER_USER_FUNC(smartTerrainTrackerInitBuilder);
	REGISTER_USER_FUNC(smartTerrainTrackerDeinitBuilder);
	REGISTER_USER_FUNC(smartTerrainBuilderCreateReconstructionFromTarget);
	REGISTER_USER_FUNC(smartTerrainBuilderCreateReconstructionFromEnvironment);
	REGISTER_USER_FUNC(smartTerrainBuilderAddReconstruction);
	REGISTER_USER_FUNC(smartTerrainBuilderRemoveReconstruction);
	REGISTER_USER_FUNC(smartTerrainBuilderDestroyReconstruction);
	REGISTER_USER_FUNC(reconstructionStart);
	REGISTER_USER_FUNC(reconstructionStop);
	REGISTER_USER_FUNC(reconstructionIsReconstructing);
	REGISTER_USER_FUNC(reconstructionReset);
	REGISTER_USER_FUNC(reconstructionSetNavMeshPadding);
	REGISTER_USER_FUNC(reconstructionFromTargetSetInitializationTarget);
	REGISTER_USER_FUNC(reconstructionSetMaximumArea);
	REGISTER_USER_FUNC(reconstructioFromEnvironmentGetReconstructionState);
	REGISTER_USER_FUNC(cameraDeviceInitCamera);
	REGISTER_USER_FUNC(cameraDeviceDeinitCamera);
	REGISTER_USER_FUNC(cameraDeviceStartCamera);
	REGISTER_USER_FUNC(cameraDeviceStopCamera);
	REGISTER_USER_FUNC(cameraDeviceGetNumVideoModes);
	REGISTER_USER_FUNC(cameraDeviceGetVideoMode);
	REGISTER_USER_FUNC(cameraDeviceSelectVideoMode);
	REGISTER_USER_FUNC(cameraDeviceSetFlashTorchMode);
	REGISTER_USER_FUNC(cameraDeviceSetFocusMode);
	REGISTER_USER_FUNC(cameraDeviceSetCameraConfiguration);
	REGISTER_USER_FUNC(cameraDeviceGetCameraFieldOfViewRads);
	REGISTER_USER_FUNC(qcarSetFrameFormat);
	REGISTER_USER_FUNC(dataSetExists);
	REGISTER_USER_FUNC(dataSetLoad);
	REGISTER_USER_FUNC(dataSetGetNumTrackableType);
	REGISTER_USER_FUNC(dataSetGetTrackablesOfType);
	REGISTER_USER_FUNC(dataSetGetTrackableName);
	REGISTER_USER_FUNC(dataSetCreateTrackable);
	REGISTER_USER_FUNC(dataSetDestroyTrackable);
	REGISTER_USER_FUNC(dataSetHasReachedTrackableLimit);
	REGISTER_USER_FUNC(getCameraThreadID);
	REGISTER_USER_FUNC(imageTargetBuilderBuild);
	REGISTER_USER_FUNC(frameCounterGetBenchmarkingData);
	REGISTER_USER_FUNC(imageTargetBuilderStartScan);
	REGISTER_USER_FUNC(imageTargetBuilderStopScan);
	REGISTER_USER_FUNC(imageTargetBuilderGetFrameQuality);
	REGISTER_USER_FUNC(imageTargetBuilderGetTrackableSource);
	REGISTER_USER_FUNC(imageTargetCreateVirtualButton);
	REGISTER_USER_FUNC(imageTargetDestroyVirtualButton);
	REGISTER_USER_FUNC(virtualButtonGetId);
	REGISTER_USER_FUNC(imageTargetGetNumVirtualButtons);
	REGISTER_USER_FUNC(imageTargetGetVirtualButtons);
	REGISTER_USER_FUNC(imageTargetGetVirtualButtonName);
	REGISTER_USER_FUNC(cylinderTargetGetDimensions);
	REGISTER_USER_FUNC(cylinderTargetSetSideLength);
	REGISTER_USER_FUNC(cylinderTargetSetTopDiameter);
	REGISTER_USER_FUNC(cylinderTargetSetBottomDiameter);
	REGISTER_USER_FUNC(objectTargetSetSize);
	REGISTER_USER_FUNC(objectTargetGetSize);
	REGISTER_USER_FUNC(objectTrackerStart);
	REGISTER_USER_FUNC(objectTrackerStop);
	REGISTER_USER_FUNC(objectTrackerCreateDataSet);
	REGISTER_USER_FUNC(objectTrackerDestroyDataSet);
	REGISTER_USER_FUNC(objectTrackerActivateDataSet);
	REGISTER_USER_FUNC(objectTrackerDeactivateDataSet);
	REGISTER_USER_FUNC(objectTrackerPersistExtendedTracking);
	REGISTER_USER_FUNC(objectTrackerResetExtendedTracking);
	REGISTER_USER_FUNC(markerSetSize);
	REGISTER_USER_FUNC(markerTrackerStart);
	REGISTER_USER_FUNC(markerTrackerStop);
	REGISTER_USER_FUNC(markerTrackerCreateMarker);
	REGISTER_USER_FUNC(markerTrackerDestroyMarker);
	REGISTER_USER_FUNC(initPlatformNative);
	REGISTER_USER_FUNC(initFrameState);
	REGISTER_USER_FUNC(deinitFrameState);
	REGISTER_USER_FUNC(onSurfaceChanged);
	REGISTER_USER_FUNC(onPause);
	REGISTER_USER_FUNC(onResume);
	REGISTER_USER_FUNC(hasSurfaceBeenRecreated);
	REGISTER_USER_FUNC(updateQCAR);
	REGISTER_USER_FUNC(rendererEnd);
	REGISTER_USER_FUNC(qcarGetBufferSize);
	REGISTER_USER_FUNC(qcarAddCameraFrame);
	REGISTER_USER_FUNC(rendererSetVideoBackgroundCfg);
	REGISTER_USER_FUNC(rendererGetVideoBackgroundCfg);
	REGISTER_USER_FUNC(rendererGetVideoBackgroundTextureInfo);
	REGISTER_USER_FUNC(rendererSetVideoBackgroundTextureID);
	REGISTER_USER_FUNC(rendererIsVideoBackgroundTextureInfoAvailable);
	REGISTER_USER_FUNC(rendererGetRecommendedFps);
	REGISTER_USER_FUNC(qcarInit);
	REGISTER_USER_FUNC(qcarSetHint);
	REGISTER_USER_FUNC(getProjectionGL);
	REGISTER_USER_FUNC(setApplicationEnvironment);
	REGISTER_USER_FUNC(setStateBufferSize);
	REGISTER_USER_FUNC(targetFinderStartInit);
	REGISTER_USER_FUNC(targetFinderGetInitState);
	REGISTER_USER_FUNC(targetFinderDeinit);
	REGISTER_USER_FUNC(targetFinderStartRecognition);
	REGISTER_USER_FUNC(targetFinderStop);
	REGISTER_USER_FUNC(targetFinderSetUIScanlineColor);
	REGISTER_USER_FUNC(targetFinderSetUIPointColor);
	REGISTER_USER_FUNC(targetFinderUpdate);
	REGISTER_USER_FUNC(targetFinderGetResults);
	REGISTER_USER_FUNC(targetFinderEnableTracking);
	REGISTER_USER_FUNC(targetFinderGetImageTargets);
	REGISTER_USER_FUNC(targetFinderClearTrackables);
	REGISTER_USER_FUNC(textTrackerStart);
	REGISTER_USER_FUNC(textTrackerStop);
	REGISTER_USER_FUNC(textTrackerSetRegionOfInterest);
	REGISTER_USER_FUNC(textTrackerGetRegionOfInterest);
	REGISTER_USER_FUNC(wordListLoadWordList);
	REGISTER_USER_FUNC(wordListAddWordsFromFile);
	REGISTER_USER_FUNC(wordListAddWordU);
	REGISTER_USER_FUNC(wordListRemoveWordU);
	REGISTER_USER_FUNC(wordListContainsWordU);
	REGISTER_USER_FUNC(wordListUnloadAllLists);
	REGISTER_USER_FUNC(wordListSetFilterMode);
	REGISTER_USER_FUNC(wordListGetFilterMode);
	REGISTER_USER_FUNC(wordListAddWordToFilterListU);
	REGISTER_USER_FUNC(wordListRemoveWordFromFilterListU);
	REGISTER_USER_FUNC(wordListClearFilterList);
	REGISTER_USER_FUNC(wordListLoadFilterList);
	REGISTER_USER_FUNC(wordListGetFilterListWordCount);
	REGISTER_USER_FUNC(wordListGetFilterListWordU);
	REGISTER_USER_FUNC(wordGetLetterMask);
	REGISTER_USER_FUNC(wordGetLetterBoundingBoxes);
	REGISTER_USER_FUNC(trackerManagerInitTracker);
	REGISTER_USER_FUNC(trackerManagerDeinitTracker);
	REGISTER_USER_FUNC(virtualButtonSetEnabled);
	REGISTER_USER_FUNC(virtualButtonSetSensitivity);
	REGISTER_USER_FUNC(virtualButtonSetAreaRectangle);
	REGISTER_USER_FUNC(qcarDeinit);
	REGISTER_USER_FUNC(startExtendedTracking);
	REGISTER_USER_FUNC(stopExtendedTracking);
	REGISTER_USER_FUNC(eyewearIsDeviceDetected);
	REGISTER_USER_FUNC(eyewearSetHeadsetPresent);
	REGISTER_USER_FUNC(eyewearSetHeadsetNotPresent);
	REGISTER_USER_FUNC(eyewearIsSeeThru);
	REGISTER_USER_FUNC(eyewearGetScreenOrientation);
	REGISTER_USER_FUNC(eyewearIsStereoCapable);
	REGISTER_USER_FUNC(eyewearIsStereoEnabled);
	REGISTER_USER_FUNC(eyewearIsStereoGLOnly);
	REGISTER_USER_FUNC(eyewearSetStereo);
	REGISTER_USER_FUNC(eyewearIsPredictiveTrackingEnabled);
	REGISTER_USER_FUNC(eyewearSetPredictiveTracking);
	REGISTER_USER_FUNC(eyewearSetProjectionClippingPlanes);
	REGISTER_USER_FUNC(eyewearGetProjectionMatrix);
	REGISTER_USER_FUNC(eyewearCPMGetMaxCount);
	REGISTER_USER_FUNC(eyewearCPMGetUsedCount);
	REGISTER_USER_FUNC(eyewearCPMIsProfileUsed);
	REGISTER_USER_FUNC(eyewearCPMGetActiveProfile);
	REGISTER_USER_FUNC(eyewearCPMSetActiveProfile);
	REGISTER_USER_FUNC(eyewearCPMGetProjectionMatrix);
	REGISTER_USER_FUNC(eyewearCPMSetProjectionMatrix);
	REGISTER_USER_FUNC(eyewearCPMGetProfileName);
	REGISTER_USER_FUNC(eyewearCPMSetProfileName);
	REGISTER_USER_FUNC(eyewearCPMClearProfile);
	REGISTER_USER_FUNC(eyewearUserCalibratorInit);
	REGISTER_USER_FUNC(eyewearUserCalibratorGetMinScaleHint);
	REGISTER_USER_FUNC(eyewearUserCalibratorGetMaxScaleHint);
	REGISTER_USER_FUNC(eyewearUserCalibratorIsStereoStretched);
	REGISTER_USER_FUNC(eyewearUserCalibratorGetProjectionMatrix);
}
...
void RegisterAllStrippedInternalCalls ()
{
	...
	void Register_UnityEngine_Animator_GetParameter ();
	Register_UnityEngine_Animator_GetParameter ();
	...
	void Register_UnityEngine_Experimental_Director_AnimatorControllerPlayable_GetParameter ();
	Register_UnityEngine_Experimental_Director_AnimatorControllerPlayable_GetParameter ();
